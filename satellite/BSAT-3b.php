...
<head>
<meta charset="utf-8">
<title>BSAT-3b/JCSAT-110R | satellite track</title>
</head>

<body>
	<p>放送衛星　BSAT-3b　/　通信衛星　JCSAT-100R</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from BSAT_3b order by Epoch desc limit 1');
