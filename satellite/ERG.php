...
<head>
<meta charset="utf-8">
<title>ERG | satellite track</title>
</head>

<body>
	<p>ジオスペース探査衛星　あらせ（ERG）</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from ERG order by Epoch desc limit 1');
