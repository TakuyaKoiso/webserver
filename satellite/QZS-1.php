...
<head>
<meta charset="utf-8">
<title>QZS-1 | satellite track</title>
</head>

<body>
	<p>準天頂衛星　みちびき初号機（QZS-1）</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from QZS1 order by Epoch desc limit 1');
		...
		echo sprintf("\n<iframe width=\"750\" height=\"650\" src=\"http://maps.google.co.jp/maps?ll=%.5f, %.5f&amp;q=準天頂QZS-1@%.5f,%.5f&amp;output=embed&amp;t=m&amp;z=3&amp;hl=ja&amp;t=m\" frameborder=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\"></iframe>", $output[6], $output[7], $output[6], $output[7])
	?>
</body>
</html>