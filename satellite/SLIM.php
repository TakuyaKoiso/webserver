...
<head>
<meta charset="utf-8">
<title>SLIM | satellite track</title>
</head>
...
<body>
	...
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from SLIM order by Epoch desc limit 1');
