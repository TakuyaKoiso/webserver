...
<head>
<meta charset="utf-8">
<title>JCSAT-110A | satellite track</title>
</head>

<body>
	<p>通信衛星　JCSAT-110A(JCSAT-15)</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from JCSAT_110A order by Epoch desc limit 1');
