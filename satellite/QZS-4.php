...
<head>
<meta charset="utf-8">
<title>QZS-4 | satellite track</title>
</head>

<body>
	<p>準天頂衛星　みちびき４号機（QZS-4）</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from QZS4 order by Epoch desc limit 1');
