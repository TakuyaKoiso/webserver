...
<head>
<meta charset="utf-8">
<title>BSAT-3c | satellite track</title>
</head>
...
<body>
	...
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from BSAT_3c order by Epoch desc limit 1');
