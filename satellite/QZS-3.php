...
<head>
<meta charset="utf-8">
<title>QZS-3 | satellite track</title>
</head>

<body>
	<p>準天頂衛星　みちびき３号機（QZS-3）</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from QZS3 order by Epoch desc limit 1');
