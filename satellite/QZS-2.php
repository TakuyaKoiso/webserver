...
<head>
<meta charset="utf-8">
<title>QZS-2 | satellite track</title>
</head>

<body>
	<p>準天頂衛星　みちびき２号機（QZS-2）</p>
	<?php
		...
		$TLE_record = $pdo->query('select Epoch,First_derivative,Inclination,Ascension,Eccentricity,Perigee,Anomaly,Motion from QZS2 order by Epoch desc limit 1');
